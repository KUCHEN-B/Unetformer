...
class LoveDATrainDataset(Dataset):
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        urban_img_filename_list = [name for name in os.listdir(osp.join(data_root, 'Urban', img_dir))
                                   if name.endswith(self.img_suffix)]
        urban_mask_filename_list = [name for name in os.listdir(osp.join(data_root, 'Urban', mask_dir))
        ...
        rural_img_filename_list = [name for name in os.listdir(osp.join(data_root, 'Rural', img_dir))
                                   if name.endswith(self.img_suffix)]
        rural_mask_filename_list = [name for name in os.listdir(osp.join(data_root, 'Rural', mask_dir))
                                    if name.endswith(self.mask_suffix)]
